...
public class VerificaFirmaDocMockUtil {
     ...
     * </p>
     *
     * @param fileWithSignature a {@link java.io.InputStream} object
     *
    ...
    public static EidasDataToValidateMetadata createMockDto(InputStream fileOriginal,
	    InputStream fileWithSignature) throws IOException {
    ...
    private static EidasDataToValidateMetadata remoteDocumentAsByteArr(
	    EidasDataToValidateMetadata dto, InputStream fileOriginal,
	    InputStream fileWithSignature) throws IOException {
    ...
    private static EidasDataToValidateMetadata remoteDocumentAsURI(EidasDataToValidateMetadata dto,
	    URI fileOriginal, URI fileWithSignature) throws IOException {
	if (fileOriginal != null) {
