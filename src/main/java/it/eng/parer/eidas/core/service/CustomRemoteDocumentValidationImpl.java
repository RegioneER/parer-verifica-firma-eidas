...
public class CustomRemoteDocumentValidationImpl implements ICustomRemoteDocumentValidation {
     ...
     *
     * @param verifier oggetto standard DSS CertificateVerifier
     */
    @Override
     ...
     * : policy/constraint.xml di default rilasciato con le librerie DSS Scenario 2 : possibile
     * effettuare diversa configurazione attraverso un file xml implementato secondo specificia
     * EIDAS, supportato il caricamento da filesystem e via classloading (e.g. file su classpath o
     * su resources)
     *
     * @param defaultValidationPolicy risorsa con file di constraint da utilizzare
     */
    @Override
     ...
     *
     * Modificati i default
     * https://github.com/esig/dss/blob/5.8.x/dss-policy-jaxb/src/main/resources/
    ...
    /**
     * Crea, ricorsivamente, l'output del processo di verifica in cui in ogni "strato" è presente un
     * livello di annidamento.
     *
     * @param dataToValidateMetadata    metadati
     * @param parent                    puntatore al padre
     * @param signedDocValidator        validatore custom per il tipo di documento.
     * @param signedDocumentName        nome del documento
     ...
     *
     * @param signedDocument         documento da verificare
     * @param dataToValidateMetadata data a cui deve essere effettuata la validazione (opzionale)
     *
